         ...
         <section>
              ...
              <div className="flex justify-center items-center px-6 py-12 max-w-6xl mx-auto ">
                  ...
                  <div className="w-full md:w-[70%] lg:w[50%] lg:ml-20 sm:ml-10">
                      <form>
                      <input className="w-full px-4 py-2 bg-white text-xl text-gray-700 rounded border-gray-300 transition ease-in-out mb-6" type="name" id="name"
                          ...
                          <p className="mb-6">Have an account? <Link to="/SignIn" className="text-red-600 hover:text-red-700 transition duration-200 ease-in-out ml-1">Sign In</Link></p>
